/* ============================================================
   간편정산(구 "찍으면 끝") — 화면용 샘플 데이터 (서버 폴백용)
   원본: design/components/data.js (시제품#1) — v2 통합 시 이식
   - 실 API(/api/receipts 등) 실패 시 화면이 이 데이터로 폴백한다
   - imgUrl: :4000 서빙 시 data_sample 미서빙 → null (화면은 null 허용)
   ============================================================ */
window.SKD = (function () {
  ...
  const AI_POLICY = {
    budgetDept: "Upstream기술팀", account: "복지-AI구독 (DIY100)",
    reviewer: "현업검토 · 이대리",
